// NOTE: we pulled in this mutation observer shim because jest and the JSDOM mutation observer were having problems and the shim doesn’t override the current mutation observer by default.
...
function clone($target, config) {
	...
	return (function copy($target) {
		...
		// its either a element, comment, doc frag or document node
			...
			if (
				recurse &&
				(config.kids || config.charData || (config.attr && config.descendents))
			) {
