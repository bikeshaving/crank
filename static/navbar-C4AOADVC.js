...
Use prop or !prop but not both.`);
  ...
  function applyColorScheme(scheme, target = document.documentElement) {
    const root = target instanceof Document ? target.documentElement : target;
    const body = target instanceof Document ? target.body : target.ownerDocument?.body;
...
@esbuild-plugins/node-globals-polyfill/Buffer.js:
   ...
   *)
*/
//# sourceMappingURL=navbar-C4AOADVC.js.map
