    ...
    (function(global, factory) {
      ...
      pp$82.isUsingKeyword = function(isAwaitUsing, isFor) {
        ...
        if (isAwaitUsing) {
          ...
          skipWhiteSpace3.lastIndex = awaitEndPos;
...
function* ContentArea({
  ...
  let initial = true;
  let contentArea;
  for ({ ref: ref2, value, children, selectionRange, renderSource, ...rest } of this) {
...
async function checkpointEditHistory(ctx, editHistory) {
  const contentArea = (await new Promise((resolve) => ctx.schedule(resolve))).querySelector("content-area");
...
var BG_DARK = "#0a0e1f";
var BG_LIGHT = "#e7f4f5";
var TEXT_DARK = "#f5f9ff";
var TEXT_LIGHT = "#0a0e1f";
					...
					${editable && jsx`
							...
							`}>
								<${CodePreview}
									...
									autoresize
									showStatus
									language=${lang.startsWith("python") ? "python" : lang.startsWith("html") ? "html" : "javascript"}
								/>
							</div>
						`}
				</div>
