...
Use prop or !prop but not both.`);
  ...
  // src/utils/use-color-scheme.ts
  function useColorScheme(ctx) {
    let currentScheme = getInitialColorScheme();
  ...
  function* ColorSchemeToggle() {
    ...
    for ({} of this) {
      ...
      const onclick2 = () => colorScheme.toggle();
      yield jsx`
			<button
				onclick=${onclick2}
				role="switch"
...
@esbuild-plugins/node-globals-polyfill/Buffer.js:
   ...
   *)
*/
//# sourceMappingURL=navbar-E7QROAQS.js.map
