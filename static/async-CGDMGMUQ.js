  ...
  for await ({ children, fallback, timeout } of this) {
    ...
    if (controller.revealOrder !== "together") {
      ...
      if (controller.tail !== "hidden") {
        yield createElement(SuspenseFallback, {
          timeout,
          schedule: initial ? () => controller.scheduleFallback(this) : void 0,
          children: fallback
        });
      }
    }
    yield createElement(SuspenseChildren, {
      schedule: initial ? () => controller.scheduleChildren(this) : void 0,
      children
    });
    initial = false;
  }
}
var SuspenseListController = Symbol.for("SuspenseListController");
...
@esbuild-plugins/node-globals-polyfill/Buffer.js:
   ...
   *)
*/
//# sourceMappingURL=async-CGDMGMUQ.js.map
