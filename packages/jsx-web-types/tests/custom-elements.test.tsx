...
declare global {
  namespace JSX {
    ...
    interface IntrinsicElements extends HTMLIntrinsicElements<FrameworkIntrinsicAttributes, FrameworkElementChildrenAttribute> {
      ...
      'custom-button': JSXProps<HTMLButtonElement, CustomButtonAttributes, FrameworkIntrinsicAttributes, FrameworkElementChildrenAttribute>;

      // Custom input with input DOM properties + custom attributes
      'custom-input': JSXProps<HTMLInputElement, CustomInputAttributes, FrameworkIntrinsicAttributes, FrameworkElementChildrenAttribute>;

      // Simple custom element with just custom attributes
      'custom-card': JSXProps<HTMLElement, { title?: string; elevated?: boolean }, FrameworkIntrinsicAttributes, FrameworkElementChildrenAttribute>;
    }
  }
}
