...
import { createJsRuleTester, createTsRuleTester } from "../test-helpers/rule-tester.js";

const ruleTester = createJsRuleTester();

describe("prop-destructuring-consistency", () => {
  it("should allow correctly destructured props", () => {
    ruleTester.run("prop-destructuring-consistency", propDestructuringConsistency, {
      valid: [
        {
          code: `
            function* Counter() {
  ...
  it("should work with TypeScript", () => {
    ...
    tsRuleTester.run("prop-destructuring-consistency", propDestructuringConsistency, {
      valid: [
        {
          code: `
